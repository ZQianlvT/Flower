...
<head>
    ...
    NREUM.info = {
        ...
        "transactionName": "el8PEkJZWg4BR04PXk9ZFQMfXFkLCg==",
        "queueTime": 0,
        "applicationTime": 19,
        "agent": ""
    }</script>
    ...
    <title>404 - 你访问的页面不存在 - Flower</title>
    ...
    <meta name="csrf-token"
          content="OeIwji3z4nc2d2VWxMGe5PMU53Lbfp6VMJWsBHe7dj1cdAgN9h8AFMhSuKIzrci2+EFiDvd6gdRbyARoXVp3xA=="/>
</head>
...
<div class="wrapper">
    ...
    <div class="topbar">
        ...
        <div class="btn-group">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/register.jsp">免费注册</a>
            <a class="btn" href="${pageContext.request.contextPath}/login.jsp">登录</a>
        </div>
    </div>
    ...
    <div class="container workspace">
        <div class="page">
            ...
            <div class="page-inner page-error" data-page-name="404 - 你访问的页面不存在">
                <img class="error-image"
                     src="${pageContext.request.contextPath}/images/404-9d913790f6a30a93879a63468105abdfeb6d0a458deeaa4093c87c401ee5caea.png"
                     alt="404"/>
                <h1 class="error-title">喔嚄，我想它已经飞走了...吧？</h1>
                <div class="error-desc">错误 404：你访问的页面不存在，<a href="javascript:history.back();">返回上页</a></div>
            </div>
...
<input type="hidden" id="server-time" value="2018-05-21 11:45:08">
