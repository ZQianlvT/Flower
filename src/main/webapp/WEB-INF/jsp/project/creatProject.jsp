...
<head>
    ...
    NREUM.info = {
        ...
        "transactionName": "el8PEkJZWg4BR04WQlZaBAVERRkMAUI=",
        "queueTime": 0,
        "applicationTime": 165,
        "agent": ""
    }</script>
    ...
    <meta name="csrf-token"
          content="ageO9D/f1NiTNOHZANxxeg26tm+jYqq1JlGMkJzCyXIPkbZ35DM2u20RPC33sCcoBu8zE49mtfRNDCT8tiPIiw=="/>
</head>
...
<input type="hidden" id="server-time" value="2018-05-21 16:30:38">
...
<input type="hidden" id="conn-guid" value="df2a434a-90a6-42ac-bb3f-735c709be976">
