        ...
        <span class="message-title">
            ...
            巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉
                ...
                <script type="text/html" id="tpl-topics-select">
                    <ul>
                        <li>
                            <a href="/projects/e26956389763492f891259d7d9c5b94d/topics" class="active" data-stack
                               data-stack-replace>
                                <i class="twr twr-clock-o"></i> 正在进行
                            </a>
                        </li>
                        <li>
                            <a href="/projects/e26956389763492f891259d7d9c5b94d/topics?finish=true" class="" data-stack
                               data-stack-replace>
