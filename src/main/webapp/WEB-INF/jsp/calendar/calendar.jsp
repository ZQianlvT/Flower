...
<head>
    ...
    <style>
        .my-cal-name {
         ...
         #page-calendar .calendar-sidebar .cal-list li .my-link-cal-setting{
             position: absolute;
             top: 4px;
             right: 0;
             width: 16px;
             ...
             font-size: 12px;
             line-height: 20px;
             background: url(/Flower/images/icon-calendar-setting-947e9242b345cb84e98c1dbf15d9329e19096fae56b295c90392d29d7c3e084d.png) no-repeat center 0;
         }
    </style>
</head>
...
<div class="wrapper">
    ...
    <div class="container workspace" data-stack-fluid>
        <div class="page">
            ...
            <div class="page-inner" id="page-calendar" data-page-name="日历" data-stack-fluid>
                        ...
                        <div class="sidebar-wrapper">
                            <div class="cals">
                                ...
                                <div class="project-cals">
                                    ...
                                    <ul class="cal-list">
                                        <c:forEach items="${requestScope.projectList}" var="project" varStatus="status">
                                            <li data-guid="${project.id}" data-color="${status.count+4}" data-project>
                                                <a href="javascript:;"
                                                   class="link-show-cal link-cal-color cal-color-${status.count+4} selected"><span><i
                                                        class="twr twr-check"></i></span></a>
                                                <span class="my-cal-name" title="${project.name}">${project.name}</span>
                                                <a href="javascript:;" class="my-link-cal-setting" title="设置"
                    ...
                    <div class="calendar-wrapper">
                        <div class="calendar-topbar">
                            ...
                            <div class="nav-buttons">
                                <a class="btn-prev-month" title="上个月">
                                    <i class="twr twr-angle-left"></i>
                                </a>
                                <a class="btn-next-month" title="下个月">
                        ...
                        <div class="cal-event-popover">
                            <div class="cal-event-form">
                                <form class="form form-event"
                                      action="${pageContext.request.contextPath}/schedule/addSchedule" method="post"
                                    ...
                                    <div class="form-item">
                                        ...
                                        <c:forEach items="${requestScope.userList}" var="user">
                                            <label><input type="checkbox" name="ids" value="${user.id}"> ${user.name}
                                                (${user.email})</label><br>
                                        </c:forEach>
                                    </div>
                                    <div class="form-item">
                                        <button class="btn btn-primary"
                                                data-disable-with="正在提交...">保存</button>
                                    </div>
...
<script id="IntercomSettingsScriptTag">window.intercomSettings = {
    ...
    "email_received": 0,
    "data_updated_at": "2018-05-29T01:57:18.616Z",
