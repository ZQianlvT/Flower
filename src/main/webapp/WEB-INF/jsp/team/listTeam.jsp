...
<head>
    ...
    NREUM.info = {
        ...
        "transactionName": "el8PEkJZWg4BR04LVVRSBBRDGV8MAFAZ",
        "queueTime": 0,
        "applicationTime": 147,
        "agent": ""
    }</script>
    ...
    <meta name="csrf-token"
          content="dohAqFV8nJFbY0E5kssc/lekG+C4lw/CSOD0WX1DOQMTHngrjpB+8qVGnM1lp0qsXPGenJSTEIMjvVw1V6I4+g=="/>
</head>
    ...
    <div class="header">
        <div class="header-container">
            ...
            <ul class="nav">
                ...
                <li class="active" id="nav-members">
            ...
            <div class="page-inner" id="page-members" data-page-name="团队">
                ...
                <div class="members-main">
                    ...
                    <div class="init-members init-group">
                        <div class="init-title">当前分组没有成员</div>
                        <div class="init-desc">管理员可以在「分组设置」中添加成员到此分组</div>
                    </div>

                    <div class="init-members init-visitor">
                        <div class="init-title">当前团队还没有访客</div>
                        <div class="init-desc">访客可以参与项目的进行，<br>但只能看到和自己在同一个项目的团队成员。</div>
                    </div>
...
<input type="hidden" id="conn-guid" value="248e4909-1fe8-4b0a-8a09-3c942864e8c9">
