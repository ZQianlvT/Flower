...
<head>
    ...
    NREUM.info = {
        ...
        "transactionName": "el8PEkJZWg4BR04PXk9ZFQMfWFMV",
        "queueTime": 0,
        "applicationTime": 413,
        "agent": ""
    }</script>
    ...
    <meta name="csrf-token"
          content="sdQCf435JhqJwAed9Etx22HX0uP4aMhGjKYJQMG1FR3UQjr8VhXEeXfl2mkDJyeJaoJXn9Rs1wfn+6Es61QU5A=="/>
</head>
...
<input type="hidden" id="server-time" value="2018-05-21 18:17:30">
...
<input type="hidden" id="conn-guid" value="9c0e4e29-160d-429f-af9a-6abd62ead977">
